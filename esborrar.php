...
<body>
    ...
    $missatgeExit = 'L´album s´ha esborrat correctament';
    $missatgeError = "Error a l´esborrar l´album";
    ...
    if (isset($_POST['esborrar'])) {
        ...
        $resultat->execute(array($id,$band,$titol,$any));
    ...
    <form action="" method="post">
        <h2>Estàs segur que vols esborrar aquest registre?</h2>
        ...
        <button type=" submit" class="btn btn-dark" name="esborrar" id="enviar">Esborrar</button>
    </form>
